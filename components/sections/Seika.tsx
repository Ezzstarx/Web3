        ...
        <section id="seika" className="screen-section relative overflow-hidden bg-black pt-32 pb-8 md:pt-40 md:pb-10">
            ...
            <div className="page-x relative z-10">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-6">
                    ...
                    {/* Left: 3D SKA Coin — smaller footprint */}
                    ...
                    {/* Middle: Title + Description — tighter, smaller text */}
                    <div className="flex flex-col items-center lg:items-start max-w-[400px] text-center lg:text-left">
                        <div className="relative pb-3 mb-4 w-fit mx-auto lg:mx-0">
                            <h2 className="text-2xl md:text-[32px] font-tektur font-medium text-white tracking-[-1px]">
                                Seika (SKA)
                            </h2>
                            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[120%] h-[1px] bg-gradient-to-r from-transparent via-[#DE3BD6] to-transparent"></div>
                        </div>
